...
function Mail(props) {
    ...
    return (
      <form ref={form} onSubmit={sendEmail} className={`${props.display} text-white fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  border border-[#565656] rounded-2xl h-auto w-auto bg-[#1f1f1f] flex flex-col items-center justify-center p-5`} >
        ...
        <input type="email" name="user_email" className={`w-60 h-14 bg-[#565656] rounded-full border border-[#565656] hover:border-[#28e98c] outline-none focus:border-[#28e98c] p-2 font-bold tracking-wider cursor-pointer`}/>
        <label className={`m-2`}>Message</label>
        <textarea name="message" className={`w-60 h-24 bg-[#565656] rounded-md border border-[#565656] hover:border-[#28e98c] outline-none focus:border-[#28e98c] p-2 font-bold mb-2 tracking-wider cursor-pointer`}/>
        <input type="submit" onClick={hello} value="SEND" className={`h-14 border text-black border-[#28e98c] bg-[#28e98c] w-4/5 rounded-full cursor-pointer hover:bg-black hover:text-[#28e98c]`}/>
