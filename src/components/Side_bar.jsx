...
function Side_bar() {
  return (
    <div className="border-[#565656] border h-auto  xl:w-4/5 w-full rounded-3xl p-8">
      ...
      <img
        src={profile}
        alt="img"
        className="h-56 w-60 grayscale  m-auto mb-11 rounded-3xl"
      />
      ...
      <a href="https://nitesh32.github.io/nit_folio/" className="h-full w-full border-2 border-[#28e98c] bg-[#28e98c] rounded-full px-auto text-black hover:text-[#28e98c] hover:bg-black flex items-center justify-center ease-in-out duration-300">
